...
RunService.RenderStepped:Connect(function()
    ...
    for player, esp in pairs(ESPTable) do
        ...
        if hrp and hum and hum.Health > 0 then
            ...
            -- ✏️ Offset ESP Box вбік
local offsetX = 0 -- відступ ESP у пікселях праворуч

-- Позиції з урахуванням відступу
local xPos, yPos = pos.X - boxWidth / 2 + offsetX, pos.Y - boxHeight / 2
            ...
            if barEnabled then
                ...
                local lowColor = flags["color hp low"] or Color3.fromRGB(255, 255, 255)
                local fullColor = flags["color hp full"] or Color3.fromRGB(255, 255, 255)
